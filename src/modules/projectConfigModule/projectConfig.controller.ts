...
import { validateUUID } from "../../utils/guid";
import { Logger } from "@nestjs/common";
import { InternalGuard } from "../guardsModule/internal.guard";
import { ProjectConfigDocDto } from "./dto/projectConfig.dto";
  ...
  private _assertUuid(value: string): void {
    if (!validateUUID(value)) {
      throw badRequestException(this._logger, {
        errorMsgUser: "Invalid project id",
      });
    }
  }
}
